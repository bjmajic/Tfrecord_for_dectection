...
class TfExampleDecoder(data_decoder.DataDecoder):
    ...
    def __init__(self, load_instance_masks=False, label_map_proto_file=None, use_display_name=False):
        ...
        :param load_instance_masks:
        :param label_map_proto_file:
        :param use_display_name:
        """
    ...
    def decode(self, tf_example_string_tensor):
        ...
        :param tf_example_string_tensor:
        :return:
    ...
    def _reshape_instance_masks(self, keys_to_tensors):
        """
        Reshape instance segmentation masks. The instance segmentation masks are reshaped to [num_instances, height,
        width] and cast to boolean type to save memory.
        :param keys_to_tensors: a dictionary from keys to tensors.
        :return:  A 3-D float tensor of shape [num_instances, height, width] with values
        in {0, 1}.
        """
